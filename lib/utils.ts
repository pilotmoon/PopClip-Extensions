 ...
 */
function preserveEndSpace(text: string, f: (s: string) => string): string {        
 ...
 * @param f The transformation function
 */
function replaceSpaces(text: string, character: string): string {        
...
export = { preserveEndSpace, replaceSpaces }