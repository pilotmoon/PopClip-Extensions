...
Every extension must define a configuration dictionary. This can be provided in a file called either `Config.json`, `Config.yaml` or `Config.plist`.
...
Note that JavaScript Module extensions (see TODO) may choose to omit the Config file.
