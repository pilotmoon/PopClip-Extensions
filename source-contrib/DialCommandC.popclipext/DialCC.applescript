on run
	...
	tell application "System Events"
 		set theDevice to my urlencode("Giacometti") as string
		set theQuery to "{query}" as string
		set theURL to "command-c://x-callback-url/copyText?deviceName=" & theDevice & "&text=tel%3A%2F%2F" & theNewString
